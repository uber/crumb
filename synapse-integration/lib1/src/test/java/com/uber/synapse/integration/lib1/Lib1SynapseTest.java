...
package com.uber.synapse.integration.lib1;
...
public final class Lib1SynapseTest {

  private static final String EXPECTED_MODEL_JSON = "{\"foo\":\"foo\"}";
  private static final String EXPECTED_ENUM_JSON = "\"foo\"";
  private final Gson gson = new GsonBuilder().registerTypeAdapterFactory(Lib1Synapse.create())
      .create();
  private final Moshi moshi = new Moshi.Builder().add(Lib1Synapse.create())
      .build();
