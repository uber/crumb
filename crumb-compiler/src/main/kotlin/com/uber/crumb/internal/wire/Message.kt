...
internal abstract class Message<M : Message<M, B>, B : Message.Builder<M, B>>
protected constructor(
  /** The [ProtoAdapter] for encoding and decoding messages of this type. */
  @field:Transient @get:JvmName("adapter") val adapter: ProtoAdapter<M>,
  ...
  val unknownFields: ByteString = unknownFields
    get() {
