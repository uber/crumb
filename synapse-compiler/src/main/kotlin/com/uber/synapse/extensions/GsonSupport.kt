...
/**
 * Gson support for Synapse.
 */
class GsonSupport : SynapseExtension {

  companion object {
    private const val AV_PREFIX = "AutoValue_"
    private const val EXTRAS_KEY = "synapse.extensions.gson"
  }
  ...
  /**
   * Creates a synapse implementation method for the gson support. In this case, it builds the create() method of
   * [TypeAdapterFactory].
   *
