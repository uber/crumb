...
public final class Lib1ProducerTest {
  ...
  public void verifyMoshi() {
    Lib1Model model = Lib1Model.create("foo");
    String modelJson = moshi.adapter(Lib1Model.class).toJson(model);
    assertThat(modelJson).isEqualTo(EXPECTED_MODEL_JSON);
    Lib1Model returnedModel = null;
    try {
      returnedModel = moshi.adapter(Lib1Model.class).fromJson(modelJson);
    } catch (IOException e) {
    ...
    Lib1Enum lib1Enum = Lib1Enum.FOO;
    String lib1EnumJson = moshi.adapter(Lib1Enum.class).toJson(lib1Enum);
    assertThat(lib1EnumJson).isEqualTo(EXPECTED_ENUM_JSON);
    Lib1Enum returnedEnum = null;
    try {
      returnedEnum = moshi.adapter(Lib1Enum.class).fromJson(lib1EnumJson);
    } catch (IOException e) {
